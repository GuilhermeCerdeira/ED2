...
int main(){
        ...
        if(opcao == 1){
            while(opcao2 != 13){
                ...
                if(opcao2 == 9){//listar hash
                    ...
                    if(opcao3 == 3){//listar hashes executandos
    ...
    printf("Tempo de insercao da hash com enderecamento aberto (sondagem linear): %.20lf ms.\n", ((double)inserirHashEaSltotal) / CLOCKS_PER_SEC * 1000);
    printf("Tempo de insercao da hash com enderecamento aberto (sondagem quadratica): %.20lf ms.\n", ((double)inserirHashEaSqtotal) / CLOCKS_PER_SEC * 1000);
    printf("Tempo de insercao da hash com encadeamento separado (sondagem linear): %.20lf ms.\n", ((double)inserirHashEsSltotal) / CLOCKS_PER_SEC * 1000);

    fprintf(outfile,"Tempo de insercao da hash com enderecamento aberto (sondagem linear): %.20lf ms.\n", ((double)inserirHashEaSltotal) / CLOCKS_PER_SEC * 1000);
    fprintf(outfile,"Tempo de insercao da hash com enderecamento aberto (sondagem quadratica): %.20lf ms.\n", ((double)inserirHashEaSqtotal) / CLOCKS_PER_SEC * 1000);
    fprintf(outfile,"Tempo de insercao da hash com encadeamento separado (sondagem linear): %.20lf ms.\n", ((double)inserirHashEsSltotal) / CLOCKS_PER_SEC * 1000);

    fprintf(outhash1,"Tempo de insercao da hash com enderecamento aberto (sondagem linear): %.20lf ms.\n", ((double)inserirHashEaSltotal) / CLOCKS_PER_SEC * 1000);
    fprintf(outhash2,"Tempo de insercao da hash com enderecamento aberto (sondagem quadratica): %.20lf ms.\n", ((double)inserirHashEaSqtotal) / CLOCKS_PER_SEC * 1000);
    fprintf(outhash3,"Tempo de insercao da hash com encadeamento separado (sondagem linear): %.20lf ms.\n", ((double)inserirHashEsSltotal) / CLOCKS_PER_SEC * 1000);
